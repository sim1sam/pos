...
<div class="container py-4">
    ...
    <?php if (isset($_GET['success'])): ?>
        <div class="alert alert-success text-center">Invoice saved successfully.</div>
    <?php endif; ?>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="invoice_edit.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-secondary">Edit</a>
                                <a href="invoice_delete.php?id=<?= $row['id'] ?>" onclick="return confirm('Are you sure?')" class="btn btn-sm btn-outline-danger">Delete</a>
                                <a href="invoice_gst_create.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-primary">GST Invoice</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
